class Api::V1::JourneysController < ApplicationController
  ...
  def current_journey
    ...
    render json: @journey, include: [{ trip: { include: { trip_place_infos: { include: { place: { include: [:address, :category_dictionaries], methods: :google_maps_url } } } } } }, :user, :journey_place_infos]
  end
